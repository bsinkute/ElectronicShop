...
{
    public class UserDc : IUser
    {
        private readonly IDataService<NewUser> _newUserDataService;

        public UserDc(IDataService<NewUser> newUserDataService)
        {
        ...
        public void Login(List<UserDc> users)
        {
            // login
            ...
            UserDc user = users.Find(u => u.Username == userName && u.Password == password);
        ...
        public void RegisterUser(List<UserDc> users)
        {
            Console.WriteLine("Enter your username:");
            string username = Console.ReadLine();
            Console.WriteLine("Enter your password:");
        ...
        public List<UserDc> LoadUsers()
        {
            List<UserDc> users = new List<UserDc>();
